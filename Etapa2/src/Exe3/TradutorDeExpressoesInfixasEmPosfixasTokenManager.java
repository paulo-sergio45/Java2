/* Generated By:JavaCC: Do not edit this line. TradutorDeExpressoesInfixasEmPosfixasTokenManager.java */
package Exe3;
import java.io.*;

/** Token Manager. */
public class TradutorDeExpressoesInfixasEmPosfixasTokenManager implements TradutorDeExpressoesInfixasEmPosfixasConstants
{
...
null, null, null, null, "\74\76", "\50", "\51", "\53", "\55", "\52", "\57", 
"\40\45", "\73", };
...
/** Constructor. */
public TradutorDeExpressoesInfixasEmPosfixasTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public TradutorDeExpressoesInfixasEmPosfixasTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
