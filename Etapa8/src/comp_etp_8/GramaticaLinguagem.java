...
public class GramaticaLinguagem implements GramaticaLinguagemConstants {
  ...
  static final public LinkedList < String > expressaoRelacao() throws ParseException {
  ...
  static final public String termo() throws ParseException {
  String exp = null;
    exp = termo1();
    label_7:
    while (true) {
  ...
  static final public String termo1() throws ParseException {
  String exp = null;
    exp = termo2();
    label_8:
    while (true) {
  ...
  static final public String termo2() throws ParseException {
  String exp = null;
    exp = termo3();
    label_9:
    while (true) {
  ...
  static final public String termo3() throws ParseException {
  String exp = null;
    exp = termo4();
    label_10:
    while (true) {
  ...
  static final public String termo4() throws ParseException {
  String exp = null;
    exp = termo5();
    label_11:
    while (true) {
  ...
  static final public String termo5() throws ParseException {
  String exp = null;
    exp = termo6();
    label_12:
    while (true) {
  ...
  static final public String termo6() throws ParseException {
  String exp = null;
    exp = termo7();
    label_13:
    while (true) {
  ...
  static final public String termo7() throws ParseException {
  String exp = null;
    exp = termo8();
    label_14:
    while (true) {
  ...
  static final public String termo8() throws ParseException {
  String exp = null;
  int cont = 0;
  Token t = null;
    label_15:
  ...
  static final public String fator() throws ParseException {
  String exp = null;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VERDADEIRO:
